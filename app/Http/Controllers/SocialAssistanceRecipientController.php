...
class SocialAssistanceRecipientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Penerima Bantuan Sosial Gagal Diambil', null, 500);
        }
    }
    ...
    public function store(SocialAssistanceRecipientStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Penerima Bantuan Sosial Gagal Dibuat', null, 500);
        }
    }
    ...
    public function update(SocialAssistanceRecipientUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Penerima Bantuan Sosial Gagal Diupdate', null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Penerima Bantuan Sosial Gagal Dihapus', null, 500);
        }
    }
}
