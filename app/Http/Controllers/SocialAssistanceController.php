...
class SocialAssistanceController extends Controller
{
    ...
    public function update(SocialAssistanceUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Bantuan Sosial Berhasil Diupdate', SocialAssistanceResource::make($socialAssistance), 200);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, 'Data Bantuan Sosial Gagal Diupdate', null, 500);
        }
    }
