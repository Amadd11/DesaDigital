...
class DevelopmentController extends Controller implements HasMiddleware
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Pembangunan Gagal Diambil', null, 500);
        }
    }
    ...
    public function store(DevelopmentStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Pembangunan Berhasil Disimpan', DevelopmentResource::make($development), 201);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, 'Data Pembangunan Gagal Disimpan', null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Pembangunan Gagal Dihapus', null, 500);
        }
    }
}
