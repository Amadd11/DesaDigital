...
class EventParticipantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Peserta Event Gagal Diambil', null, 500);
        }
    }
    ...
    public function store(EventParticipantStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Peserta Event Gagal Ditambahkan', null, 500);
        }
    }
    ...
    public function update(EventParticipantUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Peserta Event Gagal Diupdate', null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Peserta Event Gagal Dihapus', null, 500);
        }
    }
}
