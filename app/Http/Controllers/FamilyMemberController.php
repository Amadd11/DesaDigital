...
class FamilyMemberController extends Controller
{
    ...
    public function store(FamilyMemberStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(true, 'Data Anggota Keluarga Berhasil Dibuat', new FamilyMemberResource($familyMember), 201);
        } catch (\Exception $e) {
            return ResponseHelper::jsonResponse(false, 'Data Anggota Keluarga Gagal Dibuat', null, 500);
        }
    }
    ...
    public function update(FamilyMemberUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Anggota Keluarga Gagal Diupdate', null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Anggota Keluarga Gagal Dihapus', null, 500);
        }
    }
}
