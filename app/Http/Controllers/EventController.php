...
class EventController extends Controller
{
    ...
    public function getAllPaginated(Request $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Event Gagal Diambil', null, 500);
        }
    }
    ...
    public function store(EventStoreRequest $request)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Event Gagal Dibuat', null, 500);
        }
    }
    ...
    public function update(EventUpdateRequest $request, string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Event Gagal Diupdate', null, 500);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return ResponseHelper::jsonResponse(false, 'Data Event Gagal Dihapus', null, 500);
        }
    }
}
