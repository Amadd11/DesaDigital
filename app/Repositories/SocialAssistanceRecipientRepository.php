...
class SocialAssistanceRecipientRepository implements SocialAssistanceRecipientRepositoryInterface
{
    ...
    public function getAll(
        ...
        $query = SocialAssistanceRecipient::query()->where(function ($query) use ($search) {
            if ($search) {
                $query->search($search);
            }
        });
    ...
    public function getById(
        ...
        $query = SocialAssistanceRecipient::query()->where('id', $id);
    ...
    public function update(
        ...
        DB::beginTransaction();
        try {
            $socialAssistanceRecipient = SocialAssistanceRecipient::query()->find($id);
